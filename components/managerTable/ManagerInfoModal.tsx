...
const InfoManagerModal = ({ open, setOpen, data, isPending }: Props) => {
  return (
          ...
          <>
            <DialogHeader>
              ...
              <DialogDescription className="sr-only">
                {data
                  ? `${data.first_name} ${data.last_name} ning profil ma'lumotlari`
...
export default InfoManagerModal;
